...
def work_landmark(raw_img_path, out_img_dir, img_name, face_landmarks, output_size=256,
                  just_crop=False):
        ...
        for img_name in files:
            ...
            for i, face_landmarks in enumerate(
                ...
                job = pool.apply_async(
                    work_landmark,
                    (raw_img_path, ALIGNED_IMAGES_DIR, img_name,
                     face_landmarks, args.output_size, args.just_crop),
