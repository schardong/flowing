...
class LandmarksDetector:
    ...
    def get_landmarks(self, image):
        img = np.array(PIL.Image.open(image).convert("RGB"))
...
def work_landmark(
    ...
    aligned_face_path = os.path.join(out_img_dir, face_img_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("input_imgs_path", type=str, help="input images directory path")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="Size of the output" " images. By default is 256, meaning 256x256 pixels.",
    )
    parser.add_argument(
        "--n-tasks",
        type=int,
        default=4,
        help="Number of parallel jobs to" " run. By default is 4.",
    )
